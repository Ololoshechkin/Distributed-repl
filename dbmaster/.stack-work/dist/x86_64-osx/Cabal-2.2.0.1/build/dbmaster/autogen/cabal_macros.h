...
/* package dbmaster-0.1.0.0 */
#ifndef VERSION_dbmaster
#define VERSION_dbmaster "0.1.0.0"
#endif /* VERSION_dbmaster */
#ifndef MIN_VERSION_dbmaster
#define MIN_VERSION_dbmaster(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_dbmaster */
...
#define CURRENT_COMPONENT_ID "dbmaster-0.1.0.0-InqCxdYO4rJ3zKRbGHj204-dbmaster"
